...
export default function Contact() {
  ...
  const contactOptions = [
    ...
    },
    {
      ...
      description: "Press interviews, media coverage, and promotional opportunities",
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Ready to join our journey to the World Finals? Choose how you&apos;d like to connect with us.
          </motion.p>
        </motion.div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-1">
                    <p className="font-semibold text-gray-700 font-inter">{teamData.teamInfo.school}</p>
                    <p className="text-gray-600 font-inter">{teamData.teamInfo.location}</p>
                    <p className="text-sm text-gray-500 font-inter">Established {teamData.teamInfo.founded}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {contactOptions.map((option, index) => (
            ...
            >
              <Link href={option.href}>
                <div className={`bg-gradient-to-br ${option.color} rounded-xl p-8 h-full border border-gray-200 hover:shadow-lg transition-all duration-300 group-hover:scale-105 cursor-pointer`}>
        ...
        >
          <motion.div
            variants={cardVariants}
            className="bg-gradient-to-r from-brand-blue/5 to-brand-red/5 rounded-xl p-8 md:p-12 border border-gray-200"
          >
            <div className="text-center">
