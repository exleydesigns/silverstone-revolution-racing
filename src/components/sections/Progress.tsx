  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                initial={{ height: 0 }}
                whileInView={{
                  height: division.status === "completed" ? "100%" : "75%",
                }}
                  ...
                  >
                    ...
                    >
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-300">
                        {/* Status Badge */}
                        <div
                          className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold mb-3 border ${getStatusColor(
                            milestone.status
                          )}`}
                        >
        ...
        {/* Call to Action - Updated with Gradient, No Border */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-50px" }}
        ...
        >
          ...
          >
            ...
            <p className="text-xl text-gray-700 font-inter leading-relaxed mb-8 max-w-3xl mx-auto">
              Follow our progress as we compete at the highest level of F1 in
              Schools and work towards representing Great Britain at the World
              Finals.
            </p>
